...
export const ServiceLabelsContainer = styled.div`
  display: flex;
  flex-direction: row;
  justify-content: space-between;
  height: 20px;
...
export const ServiceMainInfoContainer = styled.div`
  display: flex;
...
export const ServiceCommonInfo = styled.p`
...
export const ServiceEditContainer = styled.button`
  display: flex;
  align-items: center;
  justify-content: center;
  height: 40px;
...
export const ServiceEditIcon = styled.img`
  height: 26.5px;
  width: 26.5px;
  color: #82868c;
`;
