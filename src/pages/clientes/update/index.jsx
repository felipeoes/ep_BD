...
function UpdateCliente() {
  ...
  const handleUpdateCliente = useCallback(async (event) => {
    event.preventDefault();
    try {
      console.log(birthDate);
      const obg = {
          ...
          <Container onSubmit={handleUpdateCliente}>
            ...
            <GenderContainer>
              <GenderContainerType>
                ...
                <input id="sexo_masc" type="radio" name="sexo" checked={gender === 'M'} value="M" onChange={(event) => setGender(event.target.value)} />
              </GenderContainerType>
              <GenderContainerType>
                <label htmlFor="sexo_fem">Feminino</label>
                <input type="radio" id="sexo_fem" name="sexo" checked={gender === 'F'} value="F" onChange={(event) => setGender(event.target.value)} />
              </GenderContainerType>
            </GenderContainer>
