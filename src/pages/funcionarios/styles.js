...
export const EmployeeLabelsContainer = styled.div`
  display: flex;
  flex-direction: row;
  justify-content: space-between;
  height: 20px;
...
export const EmployeeMainInfoContainer = styled.div`
  display: flex;
...
export const EmployeeCommonInfo = styled.p`
...
export const EmployeeEditContainer = styled.button`
  display: flex;
  align-items: center;
  justify-content: center;
  height: 40px;
...
export const EmployeeEditIcon = styled.img`
  height: 26.5px;
  width: 26.5px;
  color: #82868c;
`;
